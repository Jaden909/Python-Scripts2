...
if gameStarted==1:
    ...
    def openInv():
        ...
        class sword2:
            ...
            luck=0
            crt=1
            swordSprite=PhotoImage(master=Inv,file='C:\\Users\\ejh\\Documents\\Main Scripts\\Python\\ConRPG\\Assets\\Misc\\sword2x64.png')
            swordLabel=Label(Inv,image=swordSprite,highlightbackground='black',background='grey50',highlightthickness=1)
            swordLabel.photo=swordSprite
            swordDesc=Label(Inv,text="A rusty sword dropped by orcs. Sharp but flimsy.",wraplength=150,height=4,width=20,highlightthickness=1,highlightbackground='black')
            swordTitle=Label(Inv,text='Orc Sword',background='grey75')
            countLab=Label(Inv,text=f'x{sword2Count}',background='grey75')
            atkLab=Label(Inv,text=f'+{atk} atk',foreground='red',background='grey75')
            crtLab=Label(Inv,text=f'+{crt} crt',foreground='orange',background='grey75')
            def equip():
                global currentWeapon
                currentWeapon='sword2'
                resetItemStats()
                player.attack,player.critChance=player.attack+sword2.atk,player.critChance+sword2.crt
            ...
            def show():
                if sword2State=='unlocked':
                    Inv.create_window(300,60,window=sword2.swordLabel)
                    Inv.create_window(420,60,window=sword2.swordDesc)
                    Inv.create_window(300,12,window=sword2.swordTitle)
                    Inv.create_window(300,110,window=sword2.equipButt)
                    Inv.create_window(350,110,window=sword2.atkLab)
                    Inv.create_window(385,110,window=sword2.crtLab)
                    Inv.create_window(480,110,window=sword2.countLab)
                    global sword2Count
                    if sword2Count==0:
                        sword2.equipButt.config(state='disabled',text='Out of Item')
        ...
        class sword3:
            ...
            swordLabel=Label(Inv,image=swordSprite,highlightbackground='black',background='grey50',highlightthickness=1)
            swordLabel.photo=swordSprite
            swordDesc=Label(Inv,text="A slightly dull blade, but strong.",wraplength=150,height=4,width=20,highlightthickness=1,highlightbackground='black')
            swordTitle=Label(Inv,text='Knight\'s Sword',background='grey75')
            countLab=Label(Inv,text=f'x{sword3Count}',background='grey75')
            atkLab=Label(Inv,text=f'+{atk} atk',foreground='red',background='grey75')
            crtLab=Label(Inv,text=f'+{crt} crt',foreground='orange',background='grey75')
            def equip():
                global currentWeapon
                currentWeapon='sword3'
                resetItemStats()
                player.attack,player.critChance=player.attack+sword3.atk,player.critChance+sword3.crt
            ...
            def show():
                if sword3State=='unlocked':
                    Inv.create_window(50,200,window=sword3.swordLabel)
                    Inv.create_window(170,200,window=sword3.swordDesc)
                    Inv.create_window(50,152,window=sword3.swordTitle)
                    Inv.create_window(50,250,window=sword3.equipButt)
                    Inv.create_window(100,250,window=sword3.atkLab)
                    Inv.create_window(135,250,window=sword3.crtLab)
                    Inv.create_window(230,250,window=sword3.countLab)
                    global sword3Count
                    if sword3Count==0:
                        sword3.equipButt.config(state='disabled',text='Out of Item')
                elif allUnlocked==True:
                    Inv.create_window(50,200,window=sword3.swordLabel)
                    Inv.create_window(170,200,window=sword3.swordDesc)
                    Inv.create_window(50,152,window=sword3.swordTitle)
