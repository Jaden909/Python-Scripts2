...
speedrunMode=0
import random
from customtkinter import StringVar, IntVar,CTk
...
#Title Screen
mainWin=CTk()
mainWin.title('ConRPG v0.1.1DEV')
def startGame():
...
pic=PhotoImage('Assets\\Logo\\LOGOMED.png')
label=Label(mainWin)
label['image']=pic
...
speedrunToggle=Checkbutton(mainWin,text='Speedrun Mode',command=speedrun)
label.pack()
title.pack()
startB.pack()
debugToggle.pack()
speedrunToggle.pack(pady=2)
mainWin.mainloop()
#Game code
...
if gameStarted==1:
    ...
    slash00=Label(mainCan,bg_color='grey25',image=slash0,width=65)
    slash01=Label(mainCan,bg_color='grey25',image=slash1,width=65)
    slash02=Label(mainCan,bg_color='grey25',image=slash2,width=65)
    slash03=Label(mainCan,bg_color='grey25',image=slash3,width=65)
    slash04=Label(mainCan,bg_color='grey25',image=slash4,width=65)
    slash05=Label(mainCan,bg_color='grey25',image=slash5,width=65)
    slash06=Label(mainCan,bg_color='grey25',image=slash6,width=65)
    slash07=Label(mainCan,bg_color='grey25',image=slash7,width=65)
    ...
    def SwordSlash():
        ...
        mainCan.after(slashSpeed,slash(slash01))
        mainCan.update()
        mainCan.after(slashSpeed,slash(slash02))
        mainCan.update()
        mainCan.after(slashSpeed,slash(slash03))
        mainCan.update()
        mainCan.after(slashSpeed,slash(slash04))
        mainCan.update()
        mainCan.after(slashSpeed,slash(slash05))
        mainCan.update()
        mainCan.after(slashSpeed,slash(slash06))
        mainCan.update()
        mainCan.after(slashSpeed,slash(slash07))
        mainCan.update()
...
#__________________________________________________________________________________________________________________________________________________  
    ...
    ver=Label(mainCan,text='ConRPG v0.1 ALPHA DEV',bg_color='grey25')
    ...
    mainCan.create_window(100,650,window=ver)
