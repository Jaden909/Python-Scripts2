...
pic=PhotoImage(file='Assets\\Logo\\LOGOMED.png',master=mainWin)
label=Label(mainWin)
label['image']=pic
...
if gameStarted==1:
    ...
    coinRender=Label(mainCan,image=coinSprite,background='grey75')
...
#__________________________________________________________________________________________________________________________________________________  
    ...
    ver=Label(mainCan,text='ConRPG v0.1 ALPHA DEV',background='grey75')
    ...
    mainCan.create_window(75,590,window=ver)
    mainCan.create_window(50,160,window=coinRender)
    canWin.mainloop()