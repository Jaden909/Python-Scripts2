def init():    
    ...
    nameList=json.load(open('Apps\\Scammer Destroyer\\first names.json'))
    nounList=json.load(open('Apps\\Scammer Destroyer\\nouns.json'))
    cityList=json.load(open('Apps\\Scammer Destroyer\\alaskan cities.json'))
    lastNameList=json.load(open('Apps\\Scammer Destroyer\\last names.json'))
    ccNumList=json.load(open('Apps\\Scammer Destroyer\\fake cc numbers.json'))
