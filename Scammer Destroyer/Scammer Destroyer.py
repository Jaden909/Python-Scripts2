...
nameList=json.load(open('Scammer Destroyer/first names.json'))
nounList=json.load(open('Scammer Destroyer/nouns.json'))
cityList=json.load(open('Scammer Destroyer/alaskan cities.json'))
lastNameList=json.load(open('Scammer Destroyer/last names.json'))
ccNumList=json.load(open('Scammer Destroyer/fake cc numbers.json'))
